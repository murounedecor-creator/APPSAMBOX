...
const styles = StyleSheet.create({
  ...
  modalCard: { backgroundColor: COLORS.card, borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: '90%', borderColor: COLORS.border, borderWidth: 1, overflow: 'hidden' },
